            ...
            {callInfo && (
              <div className="space-y-2">
                <p className="flex items-baseline">
                  <span className='text-sm font-semibold text-slate-500 w-24 flex-shrink-0'>宛先:</span>
                  <strong className='text-base text-indigo-600 truncate'>{callInfo.dest || '未入力'}</strong>
                </p>
                <p className="flex items-baseline">
                  <span className='text-sm font-semibold text-slate-500 w-24 flex-shrink-0'>発信元:</span>
                  <strong className='text-base text-indigo-600 truncate'>{`${callInfo.srcDisplay || '未入力'} (${callInfo.srcNumber || '不明'})`}</strong>
                </p>
              </div>
            )}
          </Modal>
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-shrink-0 text-center">
                  ...
                  <CallButton
                    ...
                    className="w-full md:w-auto py-3 px-4 text-base font-medium"
                  >
